          ...
          {loading ? (
            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8">
              {services.map((service) => (
                <Card key={service.serviceId} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Thông tin cá nhân và kết quả xét nghiệm được bảo mật tuyệt đối theo tiêu chuẩn quốc tế</p>
            </div>
            <div className="text-center">
              <CheckCircle className="w-12 h-12 text-primary-500 mx-auto mb-4" />
              <h3 className="text-lg font-semibold mb-2">Chất lượng cao</h3>
              <p className="text-gray-600">Sử dụng công nghệ hiện đại với chất lượng xét nghiệm được kiểm soát nghiêm ngặt</p>
            </div>
            <div className="text-center">
