        ...
        <div className='max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in'>
          ...
          <Card className='border-0 shadow-xl overflow-hidden animate-fade-in'>
            <CardHeader className='bg-gradient-to-r from-primary-50 to-purple-50 border-b border-primary-100'>
              ...
              <CardDescription>
                Mã đơn: <span className='font-semibold text-primary-600'>{bookingId}</span>
              </CardDescription>
            </CardHeader>
        ...
        <DialogContent className='max-w-lg'>
          ...
          {resultModal.loading ? (
            ...
            <div className='space-y-3'>
              <div>
                <span className='font-semibold'>Khách hàng:</span> {resultModal.data.customerName}
              </div>
              <div>
                <span className='font-semibold'>Dịch vụ:</span> {resultModal.data.serviceName}
              </div>
              <div>
                <span className='font-semibold'>Kết quả:</span>{' '}
                <span className='text-primary-700 font-bold'>{resultModal.data.result}</span>
              </div>
              <div>
              ...
              {resultModal.data.updatedAt && (
                <div>
                  ...
                  {new Date(resultModal.data.updatedAt).toLocaleString('vi-VN')}
                </div>
              )}
            </div>
          ) : (
