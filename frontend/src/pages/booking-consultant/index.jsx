...
// Star is unused but I'll keep it since the file indicates you rejected its removal
...
const BookingConsultant = () => {
  ...
  // Thêm state để kiểm soát việc mở/đóng dialog
  ...
  const validateForm = () => {
    ...
    if (!formData.scheduledTime) {
      ...
      // Kiểm tra thời gian đặt lịch phải sau thời điểm hiện tại ít nhất 3 tiếng
      const now = new Date()
  ...
  // Cập nhật hàm handleBookingSubmit
  const handleBookingSubmit = async (e) => {
    ...
    try {
      ...
      // Sau đó hiển thị toast thành công
              ...
              {consultants.map((consultant) => (
                ...
                >
                  <CardContent className='p-0'>
                    {/* Compact consultant card design with system color accents */}
                    <div className='p-6'>
                      <div className='flex flex-col items-center text-center mb-4'>
                        ...
                        <div className='mb-3'>
                          {consultant.avatarUrl ? (
                            ...
                            <div className='h-24 w-24 rounded-full bg-gradient-to-br from-primary-500 to-secondary-500 flex items-center justify-center text-white font-bold text-2xl shadow-md'>
                        ...
                        <div className='text-center'>
                          ...
                          {consultant.department && (
                            <div className='inline-flex items-center gap-1 text-primary-600 font-medium text-sm'>
                      ...
                      {/* Biography - styled with system color accents */}
                      {consultant.biography && (
                        <div className='mb-5'>
                          <p className='text-sm text-gray-600 italic p-3 bg-primary-50 border-l-2 border-primary-300 rounded'>
                            "
                      ...
                      {/* Booking button with system theme */}
                      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                        <DialogTrigger asChild>
                          <Button
                            className='w-full bg-gradient-primary hover:opacity-90 text-white font-medium py-2 flex items-center justify-center gap-2 shadow-sm'
                            onClick={() => {
                        ...
                        <DialogContent className='max-w-md bg-white'>
                          ...
                          <form onSubmit={handleBookingSubmit} className='mt-4 space-y-4'>
                            ...
                            <div className='bg-gradient-to-r from-primary-50 to-secondary-50 p-4 rounded-lg flex flex-col items-center text-center'>
                              ...
                              <div>
                                ...
                                <p className='text-sm text-primary-600'>
                                  {consultant.department || 'Chuyên gia tư vấn'}
                                </p>
                              </div>
                            </div>
                            ...
                            <Button
                              type='submit'
                              className='w-full bg-gradient-primary hover:opacity-90 text-white font-medium shadow'
                            >
                              Xác nhận đặt lịch
                            </Button>
                          </form>
